var plugins = [{
      ...
      plugin: require('/home/thor/Development/gatsby/vovochicopimenta/node_modules/gatsby-plugin-react-helmet-canonical-urls/gatsby-ssr'),
      ...
      options: {"plugins":[],"query":"\n        {\n          site {\n            siteMetadata {\n              title\n              description\n              siteUrl\n              site_url: siteUrl\n            }\n          }\n        }\n      ","feeds":[{"query":"\n            {\n              allMarkdownRemark(\n                sort: { order: DESC, fields: [frontmatter___date] },\n              ) {\n                edges {\n                  node {\n                    excerpt\n                    html\n                    fields { slug }\n                    frontmatter {\n                      title\n                      date\n                    }\n                  }\n                }\n              }\n            }\n          ","output":"/blog/rss.xml","title":"Vovo Chico Pimenta RSS Feed","match":"^/blog/","link":"https://feeds.feedburner.com/vovochicopimenta.cyou"}]},
    },{
